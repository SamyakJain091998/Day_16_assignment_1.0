...
public class EmployeePayrollServiceTest {
	...
	public void given3EmployeesWhenWrittenToFileShouldMatchNumberOfEmployeeEntries() throws IOException {
		...
		List<EmployeePayrollData> returnedProcessedList = new ArrayList<>();
		returnedProcessedList = employeePayrollFileIOService.processFile();
		System.out.println("Returned list is : " + returnedProcessedList);
